...
//	}
	...
	public void draw(Graphics g)
	{
		...
		g.drawImage(BigRamp.ramp1, BigRamp.x1 - 20 - (Camera.x + 200), 350 , 400 , 100 + 40 , null );
		g.drawImage(BigRamp.ramp2, BigRamp.x3 - 50 - (Camera.x + 200), 250, 400 , 200 + 40 , null );
		g.drawImage(BigRamp.ramp3, BigRamp.x8 - 5 - (Camera.x + 200), 350, 400 , 100 + 40 , null );
		g.drawImage(BigRamp.ramp4, BigRamp.x13 - 25 - (Camera.x +200), 250, 400 , 200 + 40 , null );
