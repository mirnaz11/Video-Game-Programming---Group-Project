...
//	}
	...
	public void draw(Graphics g)
	{
		...
		g.drawLine(BigRamp.x1 - Camera.x - 200, BigRamp.y1, BigRamp.x2 - Camera.x - 200, BigRamp.y2);
		g.drawLine(BigRamp.x3 - Camera.x-200, BigRamp.y3, BigRamp.x4 - Camera.x -200, BigRamp.y4);
		g.drawLine(BigRamp.x4 - Camera.x -200, BigRamp.y4, BigRamp.x5 - Camera.x-200, BigRamp.y5);
		g.drawLine(BigRamp.x5 - Camera.x -200, BigRamp.y5, BigRamp.x6 - Camera.x -200, BigRamp.y6);
		g.drawLine(BigRamp.x6 - Camera.x-200, BigRamp.y6, BigRamp.x7 - Camera.x -200, BigRamp.y7);
		g.drawLine(BigRamp.x8 - Camera.x -200, BigRamp.y8, BigRamp.x9 - Camera.x-200, BigRamp.y9);
		g.drawLine(BigRamp.x9 - Camera.x-200, BigRamp.y9, BigRamp.x10 - Camera.x -200, BigRamp.y10);
		g.drawLine(BigRamp.x11 - Camera.x-200, BigRamp.y11, BigRamp.x12 - Camera.x-200, BigRamp.y12);
		g.drawLine(BigRamp.x13 - Camera.x-200, BigRamp.y13, BigRamp.x14 - Camera.x-200, BigRamp.y14);
		g.drawLine(BigRamp.x14 - Camera.x-200, BigRamp.y14, BigRamp.x15 - Camera.x-200, BigRamp.y15);
		g.drawLine(BigRamp.x15 - Camera.x-200, BigRamp.y15, BigRamp.x16 - Camera.x-200, BigRamp.y16);
		g.drawLine(BigRamp.x17 - Camera.x-200, BigRamp.y17, BigRamp.x18 - Camera.x-200, BigRamp.y18);
		
		
		g.drawImage(BigRamp.ramp1, BigRamp.x1 - 60 - (Camera.x + 200), 350 , 400 , 100 + 40 , null );
		g.drawImage(BigRamp.ramp2, BigRamp.x3 - 80 - (Camera.x + 200), 250, 400 , 200 + 40 , null );
		g.drawImage(BigRamp.ramp3, BigRamp.x8 - 45 - (Camera.x + 200), 350, 400 , 100 + 40 , null );
		g.drawImage(BigRamp.ramp4, BigRamp.x13 - 55 - (Camera.x +200), 250, 400 , 200 + 40 , null );
		g.drawImage(BigRamp.ramp5, BigRamp.x17  - (Camera.x+200), 260, BigRamp.x18 - BigRamp.x17, 50, null);
/*
