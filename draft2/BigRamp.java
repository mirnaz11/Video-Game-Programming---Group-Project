...
public class BigRamp {
	...
	public static void BigRamp(int x_Rect, int y_Rect) {
		...
		else if ((x_Rect + 60) > (x3 - 10) && (x_Rect + 60) < (x4 - 10)
				&& create2 == true) {
		...
		else if ((x_Rect + 60) > (x4 - 10) && (x_Rect + 60) < (x5 - 10)
				&& create3 == true)
		// else if (x_Rect > (x3) && x_Rect < (x2 + 600 + 100) )
		{
			...
			create3 = false;
		} else if ((x_Rect + 60) > (x5 - 7) && (x_Rect + 60) < (x6 - 7)
				&& create4 == true)
		// else if (x_Rect > (x2 + 600 + 100) && x_Rect < (x2 + 600 + 200) )
		{
			...
			create4 = false;
		} else if ((x_Rect + 20) > (x6 - 7) && (x_Rect + 20) < (x7 - 7)
				&& create5 == true)
	...
	/*
	 * public static void check(int x_Rect) { if((x_Rect< x1 ) || ((x_Rect + 60)
	 * > x2 && (x_Rect + 60) < x3) || ((x_Rect + 60) > (x4 - 10) && (x_Rect +
	 * 60) < (x5 - 10) ) || ((x_Rect + 60) > (x5 - 10) && (x_Rect + 60) < (x6 -
	 * 10)) || ((x_Rect + 60) > (x6 - 10) && (x_Rect + 60) < (x7 - 10)))
	 * 
	...
	public void set(int x1, int y1, int x2, int y2) {
		 ...
		 * 
		 * bigRamp[1] = new SmallRamp(x2, y2, x2 + 100, y2 - 200); bigRamp[2] =
		 * new SmallRamp(x2 + 100, y2 - 200, x2 + 200, y2); bigRamp[3] = new
		 * SmallRamp(x2 + 200, y2, x1 + 600, y1);
		 */
	...
	// g.drawLine(xBottom, yBottom, xTop, yTop);
	// System.out.println("xBottom: "+xBottom+" yBottom: "+
	// yBottom+" xTop: "+xTop+" yTop: "+yTop);
	 ...
	 * xBottom = (int)(x1 * Lookup.cos[angle] - y1 * Lookup.sin[angle] +
	 * this.x1) ; yBottom = (int)(x1 * Lookup.sin[angle] + y1* Lookup.cos[angle]
	 * );
	 * 
