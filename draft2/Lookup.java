...
public class Lookup {
	...
	// cant do calculations at class scope, so you can write a functions that
	// does your calculation and
	...
	// generate the table
	/*
	 * public static void generate() { for(int degrees = 0; degrees < 360;
	 * degrees++) { //arrays will store cos, sin for all degrees cos[degrees] =
	 * Math.cos(degrees * Math.PI / 180); sin[degrees] = Math.sin(degrees *
	 * Math.PI / 180); }
	 * 
