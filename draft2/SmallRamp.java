...
public class SmallRamp {
	...
	static int x1; // These should be private, need to do the set and get
					// methods (maybe)
	static int y1;
	...
	public void draw(Graphics g) {
		...
		/*
		 * g.drawLine(x1 + 400, y1, x2 +300, y2); g.drawLine(x2 + 300, y2, x2 +
		 * 300 + 100, y2 - 200); g.drawLine(x2 + 300 + 100, y2 - 200, x2 + 300 +
		 * 200, y2); g.drawLine(x2 + 300 + 200, y2, x1 + 300 + 600, y1);
		 */
